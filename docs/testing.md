...
CollabClaw has 105 test cases across six scenario files. Everything
...
| `test/v1.1.mjs` | 28 | v0.2.0 features — persistence, history, managed expose, reconnect UX, markdown renderer, log-off. |
