...
CollabClaw has 106 test cases across six scenario files. Everything
...
| `test/v1.1.mjs` | 29 | v0.2.0 features — persistence, history, managed expose, join wait retry, reconnect UX, markdown renderer, log-off. |
